...
def ResNet50(input_shape = (64, 64, 3), classes = 6, training=False):
    ...
    X = convolutional_block(X, f=3, filters = [128, 128, 512], s = 2, initializer=glorot_uniform)
    ...
    X = convolutional_block(X, f=3, filters = [256, 256, 1024], s = 2, initializer=glorot_uniform)
    ...
    # Stage 5 (≈3 lines)
    # add `convolutional_block` with correct values of `f`, `filters` and `s` for this stage
    X = convolutional_block(X, f=3, filters = [512, 512, 2048], s = 2, initializer=glorot_uniform)
